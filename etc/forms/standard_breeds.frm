...
<Form Name="standard_breeds">
  ...
  <Block Name="standard_breeds_Block" Description="Update standard_breeds">
    ...
    <DataSource Name="standard_breeds_Block_DataSource" Connect="no">
      <Record TableName="standard_breeds"/>
    ...
    <Label Name="st_L0" Content="__('Standard für Rassen'): ">
    ...
    <Field Name="F3" DSColumn="C3" FlowOrder="3" LabelName="L3" ToolTip="__('Beschreibung des Rasse-Standard')">
