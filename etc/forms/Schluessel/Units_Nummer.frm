...
<Form Name="F11">
  ...
  <Block Name="B1247" Description="Update unit">
    ...
    <Label Name="L1195" Content="Units f&amp;uuml;r Nummern anlegen">
    ...
    <Label Name="L1199" Content="Nummernsystem">
      <Position Column="0" Position="absolute" Row="2"/>
    </Label>

    <Field Name="F1201" DSColumn="C1200" FlowOrder="0" >
      <DataSource Name="DS1248a" Connect="no">
        <Sql Statement="Select distinct short_name, short_name from codes where class='ID_SET'"/>
      </DataSource>
...
<!--    <Image Name="Image_171c" Alt="Zahlungsart" Src="/icons/pfeil_rechts_braun.png">
       <Position Column="1" Row="2" />
       <Format VerticalAlign="bottom" />
    </Image>
-->

    <Label Name="L1202" Content="Unit">
    ...
    <Field Name="F1245" DSColumn="C1244" FlowOrder="2" >
