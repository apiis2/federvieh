...
<Form Name="FCodefrm" >
  ...
  <Block Name="B64" Description="Update codes">
    ...
    <Field Name="F47" DSColumn="C46" FlowOrder="0" ToolTip="__('Schlüssel-Klasse')" LabelName="L45">
    ...
    <Field Name="F44" DSColumn="C43" FlowOrder="1" LabelName="L42" ToolTip="__('Bezeichner für den Schlüssel')">
    ...
    <Field Name="F50" DSColumn="C49" FlowOrder="2" LabelName="L48" ToolTip="__('Abkürzung für den Schlüssel')" >
    ...
    <Field Name="F53" DSColumn="C52" FlowOrder="3" LabelName="L51" ToolTip="__('Ausführliche Bezeichnung des Schlüssels')">
    ...
    <Field Name="F56" DSColumn="C55" FlowOrder="4" LabelName="L54" ToolTip="__('Ausführliche Beschreibung des Schlüssels')">
    ...
    <Field Name="F63" DSColumn="C62" FlowOrder="5" LabelName="L61" ToolTip="__('Datenbankweite eindeutige Datensatz-ID')" AR="admin" >
      <TextField Override="no" Size="10"/>
