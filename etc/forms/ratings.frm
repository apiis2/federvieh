...
<Form Name="FORM_1621885243">
  ...
  <Block Name="B54" Description="ÄÄUpdate ratings">
    ...
    <Label Name="L28" Content="__('ratings'): ">
      <Position Column="0" Columnspan="10" Position="absolute" Row="0"/>
      <Text FontSize="24px" TextDecoration="underline"/>
    </Label>

    <Label Name="L29" Content="__('ÄÄÄcage_no'): ">
    ...
    <Label Name="L32" Content="__('db_animal'): ">
    ...
    <Label Name="L37" Content="__('db_event'): ">
    ...
    <Label Name="L42" Content="__('db_rating'): ">
    ...
    <Label Name="L50" Content="__('points'): ">
